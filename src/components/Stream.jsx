...
import { setAfk, setStream, fetchProfileIfLoggedIn, showFooter } from '../actions';
...
export const Stream = ({ history, service, channel, setAfk }) => {
    return (
...
export default compose(
    ...
    lifecycle({
        ...
        componentDidUpdate(prevProps) {
            ...
            const hasChanged =
                prevProps.channel !== channel || prevProps.service !== service || prevProps.streamer !== streamer;
            if (hasChanged) {
                if (streamer) {
